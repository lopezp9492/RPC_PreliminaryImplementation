...
public class Proxy implements ProxyInterface {
    ...
    {
        System.out.println(TAG + "constructor(dispatcher)");
    ...
    */
    ...
    {
        System.out.println(TAG + ".synchExecution(remoteMethod, String[] param)");
    ...
    */
    ...
    {
        System.out.println(TAG + ".asynchExecution(remoteMethod, String[] param)");
